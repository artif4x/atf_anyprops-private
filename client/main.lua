...
local function removeProp(isWeaponSwap)
    if currentPropEntity then
        ...
        if currentActiveItem and Config.Items[currentActiveItem] then
    ...
    while true do
        ...
        for obj, _ in pairs(trackedProps) do
            if DoesEntityExist(obj) and Entity(obj).state.isAtfProp then
                ...
                -- เก็บข้อมูลปืน
                if itemName and not Config.Items[itemName] then
    ...
    CreateThread(function()
        ...
        if entity and entity > 0 then
            ...
            if value then
                ...
                if placedItemName and Config.Items[placedItemName] and Config.Items[placedItemName].collision ~= nil then
                    hasCollision = Config.Items[placedItemName].collision
                end
    ...
    if isEditing then
        ...
        CreateThread(function()
            while isEditing and currentPropEntity do
                ...
                local boneIndex = GetPedBoneIndex(ped, (Config.Items[currentActiveItem] and Config.Items[currentActiveItem].bone) or 28422)
